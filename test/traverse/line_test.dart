...
void main() {
  test('should draw a line from (0, 0) to (2, 2)', () {
    ...
    check(
      grid.traverse(GridTraversal.line(Pos(0, 0), Pos(2, 2))),
    ).deepEquals([1, 5, 9]);
  });
  ...
  test('should draw a line from (2, 2) to (0, 0)', () {
    ...
    check(
      grid.traverse(GridTraversal.line(Pos(2, 2), Pos(0, 0))),
    ).deepEquals([9, 5, 1]);
  });
  ...
  test('should fail to draw a line from (0, 0) to (3, 3)', () {
    ...
    check(
      () => grid.traverse(GridTraversal.line(Pos(0, 0), Pos(3, 3))),
    ).throws<Error>();
  });
  ...
  test('should fail to draw a line from (0, 0) to (2, 3)', () {
    ...
    check(
      () => grid.traverse(GridTraversal.line(Pos(0, 0), Pos(2, 3))),
    ).throws<Error>();
  });
  ...
  test('should fail to draw a line from (0, 0) to (3, 2)', () {
    ...
    check(
      () => grid.traverse(GridTraversal.line(Pos(0, 0), Pos(3, 2))),
    ).throws<Error>();
  });
}
